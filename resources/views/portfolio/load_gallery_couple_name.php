...
if($acount==10){
	...
	?>
	<script>
		var btn = '<div id="load_more_couplename" class="read-more " couple-name="<?php echo $couplename;?>" data-value="1"><div class="moreinfo-animationline lftln"></div><div class="moreinfo-animationline rghttln"></div><div class="moreinfo-animationline toptln"></div><div class="moreinfo-animationline btmtln"></div>Load More</div>';
